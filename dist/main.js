...
var map = {
	...
	"./bs-component/bs-component.module": [
		...
		"bs-component-bs-component-module~dashboard-dashboard-module~layout-layout-module~product-product-mod~97bf3110",
		"common",
		"bs-component-bs-component-module"
	],
    ...
    var config = new angular_6_social_login__WEBPACK_IMPORTED_MODULE_12__["AuthServiceConfig"]([
        {
            ...
            provider: new angular_6_social_login__WEBPACK_IMPORTED_MODULE_12__["FacebookLoginProvider"]("Your-Facebook-app-id")
        },
        {
            id: angular_6_social_login__WEBPACK_IMPORTED_MODULE_12__["GoogleLoginProvider"].PROVIDER_ID,
            provider: new angular_6_social_login__WEBPACK_IMPORTED_MODULE_12__["GoogleLoginProvider"]("440996014688-i488etv2h3bb2ifbfqauavgaa3k14857.apps.googleusercontent.com")
        }
    ]);
    return config;
}
...
var environment = {
    production: false,
    clientUrl: 'https://virtiledge.com/api/'
};
